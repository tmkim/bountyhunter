# Generated by Django 5.2.6 on 2025-11-06 22:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('leader', models.JSONField(blank=True, null=True)),
                ('cards', models.JSONField(blank=True, default=list)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='one_piece_decks', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'one_piece_deck',
                'indexes': [models.Index(fields=['user'], name='ix_deck_user')],
            },
        ),
    ]
